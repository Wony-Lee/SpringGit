...
<div class="col-md-12">
	<div class="row">
		...
		<div class="col-md-9 text-left mt-1">
			<h1 class="text-center">등록정보 수정</h1>
			
			<form name="updAnim" id="updAnim" action="animUpdate" method="POST"
				enctype="multipart/form-data">
				<input type="hidden" name="iidx" value="${param.iidx}">
				...
				bgcolor="skyblue">
					...
					<tbody>
						<tr>
							...
							<td width="30%">
								<input type="text" name="title" id="title" placeholder="String(제목)" value="${animal.title}">
							</td>
							...
							<td rowspan="7" width="30%">
								...
								<img src="images/${animal.image}" width="313" height="320">
							</td>
						...
						<tr>
							...
							<td width="30%">
								<input type="text" name="name" id="name" placeholder="String(작성자)" value="${animal.name }">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="15%"><b>중성화여부</b></td>
							<td width="30%">
								<input type="text" name="trans" id="trans" placeholder="String(중성화여부)" value="${animal.trans}">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="15%"><b>색상</b></td>
							<td width="30%">
								<input type="text" name="color"id="color" placeholder="String(색상)" value="${animal.color}">
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="30%">
								<input type="text" name="weight" id="weight" placeholder="String(체중)" value="${animal.weight}">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="15%"><b>성별</b></td>
							<td width="30%">
								<input type="text" name="sex"id="sex" placeholder="String(성별)" value="${animal.sex}">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="15%"><b>현황</b></td>
							<td width="30%">
							<input type="radio" value="1" name="astate"	id="astate">보호동물
							<input type="radio" value="2" name="astate"	id="astate">입양동물
							</td>
									
							<td rowspan="1" class="text-center" width="15%"><b>발견날짜</b></td>
							<td rowspan="1" width="30%">
								<input type="text" name="indate" id="indate" placeholder="String(발견날짜)" value="${animal.indate}">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="20%"><b>발견장소</b></td>
							<td width="30%">
								<input type="text" name="addr"id="addr" placeholder="String(발견장소)" value="${animal.addr}">
							</td>
								
							<td rowspan="1" class="text-center" width="20%"><b>보호센터</b></td>
							<td rowspan="1" width="30%">
								<input type="text" name="center" id="center" placeholder="String(보호중인 센터)" value="${animal.center}">
							</td>
						</tr>
						<tr>
							<td class="text-center" width="15%"><b>보호장소</b></td>
							<td colspan="2" width="30%">
							<!-- 원래 테헤란로 뒤 readonly value 앞에 리드온리 넣어야함-->
								<input type="text" name="protect" id="protect" placeholder="예) 서울시 강남구 테헤란로" value="${animal.protect}">
							</td>
						...
						<tr>
							...
							<td colspan="2" width="30%">
								<input type="text" name="tel" id="tel" placeholder="String(연락처)" value="${animal.tel}">
							</td>
							<td colspan="1" class="text-center">
								<button class="btn btn-success" onclick="accept()">수정</button>
							</td>
						</tr>
					</tbody>
				</table>
